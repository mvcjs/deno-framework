...
export default class Class {
  ...
  constructor(data = {}) {
    if(typeof data === 'string') {
      ...
      this.data = new Map(Object.entries(this.constructor.default));
      this.#dataSource = data;
    } else if(Array.isArray(data)) {
      // Store data
      this.data = new Map([...Object.entries(this.constructor.default), ...data]);
    } else {
      this.data = new Map(Object.entries({...this.constructor.default, ...data}));
    }
  }
  ...
  load(data = {}) {
    return new Promise((resolve, reject) => {
      Namespace.Loader.load(this.#dataSource, 'json').then((sourceData) => {
        ...
        this.data = new Map([...this.default, ...this.data, ...new Map(sourceData)]);
        this.#dataSource = undefined;
        // Load provided data
        return Namespace.Loader.load(data, 'json');
      }).then((data) => {
        // Merge provided data with source data
        this.data = {...this.data, ...new Map(data)};
